...
function makePath($routerName, $action){
    $path = 'App\\Http\\Controllers\\' . $routerName . '@' . $action;
    return $path;
}
...
Route::get('/order/pizzas/create', 'App\Http\Controllers\PizzaController@create')->name('pizzas.create');
